...
def main():
    ...
    st.write("Just as a confirmation, we can see that for lower BMI scores charges are lower and around "
             "BMI = 30 charges start to become higher. This is probably due to BMI Index around 30 meaning obesity.")
    ...
    st.write("It seems like there is not much of a difference in price between men and women, but"
             " men do tend to pay more extreme prices more often.")
    ...
    st.caption("For more plots, analysis and conclusion you can check out whole notebook [here.]"
